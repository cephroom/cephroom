 ...
 */
export function BinderyMark({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function Wordmark({ href = "/" }: { href?: string }) {
  return (
    <Link
      ...
      aria-label="Bindery home"
    >
      <BinderyMark className="h-[22px] w-[22px] text-accent transition-transform group-hover:-rotate-6" />
