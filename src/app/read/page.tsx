...
export const metadata: Metadata = {
  title: "Reading now",
  description:
    "Everything being served right now. Bindery has no archive — discovery is presence.",
};
    ...
    <main className="mx-auto max-w-6xl px-5 py-12 sm:py-16">
      <header className="border-b border-rule pb-8">
        ...
        <p className="mt-3 max-w-[60ch] text-[1rem] leading-relaxed text-ink-muted">
          ...
          machine, right now. Bindery holds none of it. When someone stops
    ...
    <div className="mt-10 rounded-xl border border-rule bg-paper-raised px-6 py-12 text-center">
      ...
      <p className="mx-auto mt-3 max-w-[50ch] text-[0.92rem] leading-relaxed text-ink-muted">
        {query
          ...
          : "Bindery has no archive. Nothing is stored here, so when no contributor is running a node there is genuinely nothing to show."}
      </p>
      <Link
        href="/contribute"
